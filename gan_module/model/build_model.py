...
def build_generator(
    ...
    d0_1 = conv2d_bn(
        x=input_img_noised, filters=generator_power,
        kernel_size=KERNEL_SIZE, kernel_initializer=kernel_initializer,
        weight_decay=1e-4, strides=(1, 1),
    )
    d0_2 = residual_block(
        x=d0_1, filters=generator_power,
        kernel_size=KERNEL_SIZE, kernel_initializer=kernel_initializer,
        weight_decay=1e-4, downsample=False,
    )
    # Downsampling
    d1_1 = residual_block(
        x=d0_2, filters=generator_power * 2,
        kernel_size=KERNEL_SIZE, kernel_initializer=kernel_initializer,
        weight_decay=1e-4, downsample=True, use_pooling_layer=True
    )
    d1_2 = residual_block(
        x=d1_1, filters=generator_power * 2,
        kernel_size=KERNEL_SIZE, kernel_initializer=kernel_initializer,
        weight_decay=1e-4, downsample=False,
    )
    d2_1 = residual_block(
        x=d1_2, filters=generator_power * 4,
        kernel_size=KERNEL_SIZE, kernel_initializer=kernel_initializer,
        weight_decay=1e-4, downsample=True, use_pooling_layer=True
    )
    d2_2 = residual_block(
        x=d2_1, filters=generator_power * 4,
        kernel_size=KERNEL_SIZE, kernel_initializer=kernel_initializer,
        weight_decay=1e-4, downsample=False,
    )
    d3_1 = residual_block(
        x=d2_2, filters=generator_power * 8,
        kernel_size=KERNEL_SIZE, kernel_initializer=kernel_initializer,
        weight_decay=1e-4, downsample=True, use_pooling_layer=False
    )
    d3_2 = residual_block(
        x=d3_1, filters=generator_power * 8,
        kernel_size=KERNEL_SIZE, kernel_initializer=kernel_initializer,
        weight_decay=1e-4, downsample=False
    )
    ...
    u2_2 = deconv2d(u3_1, d2_1, generator_power * 4,
                    kernel_size=KERNEL_SIZE, kernel_initializer=kernel_initializer,
                    upsample=False,)
    u2_1 = deconv2d(u2_2, d1_2, generator_power * 2,
                    kernel_size=KERNEL_SIZE, kernel_initializer=kernel_initializer,
                    upsample=True, use_upsampling_layer=True)
    u1_2 = deconv2d(u2_1, d1_1, generator_power * 2,
                    kernel_size=KERNEL_SIZE, kernel_initializer=kernel_initializer,
                    upsample=False,)
    u1_1 = deconv2d(u1_2, d0_2, generator_power,
                    kernel_size=KERNEL_SIZE, kernel_initializer=kernel_initializer,
                    upsample=True, use_upsampling_layer=False)
    u0_2 = deconv2d(u1_1, d0_1, generator_power,
                    kernel_size=KERNEL_SIZE, kernel_initializer=kernel_initializer,
                    upsample=False,)
    u0_1 = residual_block_last(
        x=u0_2, filters=output_channels,
        kernel_size=KERNEL_SIZE, kernel_initializer=kernel_initializer,
        weight_decay=1e-4, downsample=False,
    )
